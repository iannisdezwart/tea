...
Assembler stack_demo()
{
	...
	assembler.move_frame_offset_64_into_reg(-CPU::stack_frame_size - 16, R_RET_ID);
	assembler.move_frame_offset_64_into_reg(-CPU::stack_frame_size - 24, R_0_ID);

	// Add parameter 2 into parameter 1

	assembler.add_reg_into_reg(R_0_ID, R_RET_ID);
...
Assembler static_data_demo()
{
	...
	assembler.move_reg_into_mem_8(R_2_ID, IO_DEVICE_OFFSET + IODevice::stdout_write);
